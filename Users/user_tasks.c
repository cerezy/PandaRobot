...
void robotRun()
{
    ...
    case ACTION_SideLieScratch: //  侧躺挠痒
    ...
    case ACTION_SitPatButt: //  坐着拍屁股动作
    ...
    case ACTION_StretchLying: //  躺着伸懒腰
    ...
    case ACTION_ScratchButtStanding: //  站立挠屁股
    ...
    case ACTION_SplitStanding: //  站立劈叉
...
void StartTaskHigh(void const *argument)
{
    ...
    for (;;)
    {
		if(workflag == 1)
		{
			...
			sendStateActive(&ph, stateRobot);//发送正常工作模式，初始化完成
		}
        osDelay(1);
    }
}
